...
test('index.html exists', () => {
    const f = readFileSync('/home/nrupal/vault-tracker/v2-prototype/index.html', 'utf8');
...
test('SovereignApp.js exists and is valid', () => {
    const f = readFileSync('/home/nrupal/vault-tracker/v2-prototype/ui/SovereignApp.js', 'utf8');
...
test('crypto.js exists', () => {
    const f = readFileSync('/home/nrupal/vault-tracker/v2-prototype/core/crypto.js', 'utf8');
...
test('db.js exists with all operations', () => {
    const f = readFileSync('/home/nrupal/vault-tracker/v2-prototype/core/db.js', 'utf8');
...
test('companion.js exists', () => {
    const f = readFileSync('/home/nrupal/vault-tracker/v2-prototype/core/companion.js', 'utf8');
...
test('scrubber.js exists', () => {
    const f = readFileSync('/home/nrupal/vault-tracker/v2-prototype/core/scrubber.js', 'utf8');
...
test('Task intent parsing', async () => {
    const { parseSovereignIntent } = await import('/home/nrupal/vault-tracker/v2-prototype/core/companion.js');
